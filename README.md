...
* **Intelligence Artificielle** : Les scripts de ce dashboard ont été développés ainsi que ce tuto à 99% par **Gemini 3 Flash (Google)**.
 > Une erreur sur le numéro des CPU était récurrente (temp_cpum,contre cpu0 etc.), Probablement dû au SDK qui embrouillait l’IA. Pour le reste des instructions et les tests, c’est de moi… et oui, j’ai quand même réussi à faire un petit quelque chose !
