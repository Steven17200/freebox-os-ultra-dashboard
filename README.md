...
* **Intelligence Artificielle** : Les scripts de ce dashboard ont été développés avec l'aide de **Gemini 3 Flash(Google)** pour l'optimisation du code et du design.
